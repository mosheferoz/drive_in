...
function AccessibilityIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      ...
      <path d="M21 7.5c0 .6-.5 1.1-1.1 1.1-.1 0-2.4-.4-4.4-.8v3.4l2.6 7.8c.2.7-.2 1.4-.9 1.6-.7.2-1.4-.2-1.6-.9L12 14.6l-2 4.9c-.3.7-1 1.1-1.7.9-.7-.2-1.1-1-.8-1.7l2.6-7.8V7.8c-2 .4-4.3.8-4.4.8C5 8.6 4.5 8.1 4.5 7.5S5 6.4 5.6 6.3c.1 0 3.4-.6 6.4-.6s6.3.6 6.4.6c.6.1 1.1.6 1.1 1.2z" />
    </svg>
  );
}
